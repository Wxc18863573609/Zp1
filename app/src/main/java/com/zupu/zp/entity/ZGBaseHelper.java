...
public class ZGBaseHelper {
    PublishActivityUI publishActivityUI = new PublishActivityUI();
     ...
     */
    public boolean initZegoSDK(final TextView usernumber, final LinearLayout giftParent, final Context mContext, long appID, byte[] appSign, boolean testEnv, final IZegoInitSDKCompletionCallback callback) {
        ...
        boolean initSDKResults = zegoLiveRoom.initSDK(appID, appSign, new IZegoInitSDKCompletionCallback() {
            ...
            public void onInitSDK(int i) {
                ...
                if (i == 0) {
                    ...
                    //JoinLiveLoginPublishUI.actionStart(JoinLiveMainActivityUI);
                    //jianting();
                    //配置房间信息
    ...
    public boolean loginRoom(String roomID, int role, final IZegoLoginCompletionCallback callback) {
        ...
        return zegoLiveRoom.loginRoom(roomID, role, new IZegoLoginCompletionCallback() {
            ...
            public void onLoginCompletion(int i, ZegoStreamInfo[] zegoStreamInfos) {
                ...
                for(ZegoStreamInfo z: zegoStreamInfos){
                    Log.e("TAG", "onLoginCompletion: "+"这个是?"+  z.extraInfo );
                }
