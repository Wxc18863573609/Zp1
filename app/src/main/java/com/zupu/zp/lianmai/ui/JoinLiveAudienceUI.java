...
public class JoinLiveAudienceUI extends BaseActivitys {
    ...
    // SDK配置，麦克风和摄像头
    private com.zupu.zp.entity.SDKConfigInfo sdkConfigInfo = new SDKConfigInfo();
        ...
        ZGJoinLiveHelper.sharedInstance().getZegoLiveRoom().loginRoom(mRoomID, ZegoConstants.RoomRole.Audience, new IZegoLoginCompletionCallback() {
            ...
            public void onLoginCompletion(int errorCode, ZegoStreamInfo[] zegoStreamInfos) {
                ...
                if (errorCode == 0) {
                    ...
                    Toast.makeText(JoinLiveAudienceUI.this, getString(R.string.tx_login_room_failure), Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
