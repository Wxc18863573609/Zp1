package com.zupu.zp.giftutli.widget;
...
import com.zupu.zp.giftutli.util.GiftAnimationUtil;
import com.zupu.zp.giftutli.util.glide.GlideCircleTransform;
...
//    private Timer mTimer;
    ...
    TextView anim_nickname, anim_sign,anroute;
...
//    }
    ...
    private void initView() {
        ...
        anroute=(TextView) rootView.findViewById(R.id.anroute);
    ...
    public boolean setGift(GiftModel gift) {
        ...
        if (!TextUtils.isEmpty(gift.getAnroute())) {
            anroute.setText(gift.getAnroute());
        }
        return true;
    }
