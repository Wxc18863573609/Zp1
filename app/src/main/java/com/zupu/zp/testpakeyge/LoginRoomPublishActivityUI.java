...
public class LoginRoomPublishActivityUI extends BaseActivitys {
    ...
    private void loginRoomCompletion(boolean isLoginRoom, String finalRoomId, int errorCode) {
        ...
        if (isLoginRoom) {
            Toast.makeText(LoginRoomPublishActivityUI.this, getString(R.string.tx_login_room_success), Toast.LENGTH_SHORT).show();
            ...
            Toast.makeText(LoginRoomPublishActivityUI.this, getString(R.string.tx_login_room_failure), Toast.LENGTH_SHORT).show();
        }
    }
