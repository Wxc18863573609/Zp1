...
import com.zupu.zp.entity.GetAppIdConfig;
import com.zupu.zp.entity.PreferenceUtil;

import java.util.regex.Pattern;

import static com.zupu.zp.entity.PreferenceUtil.KEY_APP_ID;
import static com.zupu.zp.entity.PreferenceUtil.KEY_APP_SIGN;
import static com.zupu.zp.entity.PreferenceUtil.KEY_TEST_ENVIRONMENT;
...
public class ZegoUtil {
    ...
    public static boolean getIsTestEnv() {
        return PreferenceUtil.getInstance().getBooleanValue(KEY_TEST_ENVIRONMENT, false);
    }
