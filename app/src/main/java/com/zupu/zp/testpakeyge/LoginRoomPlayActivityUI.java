...
import com.zupu.zp.databinding.ActivityLoginRoomBinding;
...
public class LoginRoomPlayActivityUI extends BaseActivitys {
    ...
    public void onLoginRoom(View view) {
      //  String roomId =// binding.edRoomId.getText().toString();
        ...
        String roomId =edroomid.getText().toString();
    ...
    private void loginRoomCompletion(boolean isLoginRoom, String finalRoomId, int errorCode) {
        ...
        CustomDialog.createDialog(LoginRoomPlayActivityUI.this).cancel();
        if (isLoginRoom) {
            Toast.makeText(LoginRoomPlayActivityUI.this, getString(R.string.tx_login_room_success), Toast.LENGTH_SHORT).show();
            ...
            Toast.makeText(LoginRoomPlayActivityUI.this, getString(R.string.tx_login_room_failure), Toast.LENGTH_SHORT).show();
        }
    }
