...
public class Markfragment extends BaseFragment {
    ...
    public View initlayout(LayoutInflater inflater, ViewGroup container) {
        view = inflater.inflate(R.layout.marklaout, container, false);
        return view;
    }
        ...
        web.setWebViewClient(new WebViewClient(){
            ...
            public void onPageFinished(WebView view, String url) {
               ...
               /* if (progressDialog != null && progressDialog.isShowing()) {
                ...
                boolean status = url.contains(UrlCount.Base_Head+"mobile/prayer_pavilion.html");
                if (status){
...
//        webSettings.setAppCachePath("");
        ...
        //3、 加载需要显示的网页
        //祈福馆
        web.loadUrl(UrlCount.Base_Head+"mobile/prayer_pavilion.html");
   ...
   /* public class AndroidJs{
        ...
        public void wxShare( String uuid,  String subjectId, String type, String title,String applyId) {
            ...
            Log.e("TAG", "wxShare: "+"uuid:"+uuid+"subjectId:"+subjectId+"title:"+title+"applyId:"+"applyId:"+applyId+"type:"+type);
        }
        @JavascriptInterface
