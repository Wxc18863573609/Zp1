...
public class Xuefragment extends BaseFragment {
    ...
    public View initlayout(LayoutInflater inflater, ViewGroup container) {
        view = inflater.inflate(R.layout.xuelaout, container, false);
        return view;
    }
    ...
    public void initview() {
        ...
        web=view.findViewById(R.id.xueweb);
        ...
        web.setWebViewClient(new WebViewClient(){
            ...
            public void onPageFinished(WebView view, String url) {
               ...
               /* if (progressDialog != null && progressDialog.isShowing()) {
                ...
                boolean status = url.contains(UrlCount.Base_Head+"mobile/private_school.html");
                if (status){
...
//        webSettings.setAppCachePath("");
       ...
       // webSettings.setDefaultFontSize(12);
        ...
        //3、 加载需要显示的网页
        web.loadUrl(UrlCount.Base_Head+"mobile/private_school.html");
        //监听返还上一个html
